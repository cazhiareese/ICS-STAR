import { Banknote, BriefcaseBusiness, Ellipsis, FileText, Pencil, SquareArrowOutUpRight, Star, Trash2,Flag } from 'lucide-react'
...
function JobExpandedCard({job, currentUserID}) {
    ...
    return (
        <div className="flex flex-col w-[800px] outline-0 gap-5">
            <div className='flex flex-row gap-2'>
                {/* Main Card */}
                <div className='flex flex-col outline-1 outline-neutral-300 w-7/12 rounded-2xl px-8 pt-4 pb-8 cursor'>
                    {/* Ellipsis & Modal */}
    ...
    <div className="ml-auto">
        ...
        >
            ...
            Report
                ...
                {/* Job Details Card */}
                <div className='flex flex-col outline-1 outline-neutral-300 w-5/12 rounded-2xl px-8 pt-8 pb-8 cursor'>
                    {/* Job Details */}
