...
function DonationDetailsInput(
    ...
    return (
        <div className='outline-2 rounded-3xl outline-neutral-400 py-8 px-8 w-full'>
            ...
            <textarea
                type="text"
                className="bg-white font-satoshi-medium text-md w-full h-32 md:pl-10 pl-5 pr-4 py-2 rounded-2xl text-black border border-neutral-400 focus:border-primary focus:outline-none focus:ring-0"
