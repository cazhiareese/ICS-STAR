        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 bg-opacity-10 z-50">
            <div className="bg-white rounded-3xl shadow-lg p-6 w-96">
                ...
                <div className="flex justify-center space-x-10">
                    {choiceclose &&
                        <button
                        className="px-4 py-2 bg-gray-200 text-gray-700 rounded-2xl hover:bg-gray-300 cursor-pointer font-regular"
                        onClick={onClose}
                    >
                        {choiceclose}
                    </button>
                    ...
                    {choicecontinue &&
                        <button
                            className="px-4 py-2 bg-green-500 text-white rounded-2xl hover:bg-green-600 font-regular"
                            onClick={onContinue}
                        >
                            {choicecontinue}
                        </button>
