...
function MainPanelOnboarding() {
    ...
    <div className="h-screen items-center flex flex-col">
        <div className="flex justify-center m-auto h-[95%]">
            <div className="flex flex-col items-center  z-20 bg-white xl:w-300 w-[90%] h-[90%] max-w-300 border overflow-auto rounded-4xl">
                
                {currentSection!=5 && currentSection!=0 && <div className= "my-10">
                    {ProgressBar[currentSection]}
                </div>}
                <div className="w-full rounded-xl max-h-[750px] overflow-y-auto m-auto">
