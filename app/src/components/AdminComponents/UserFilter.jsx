  ...
  return (
    <div>
      <button
        ...
        className="border border-disabled rounded-3xl px-5 py-2 flex gap-2 items-center bg-white cursor-pointer hover:border-hover duration-150 ease-in"
      >
      ...
      {open && (
        <div className="absolute z-10 mt-2 w-90 origin-top-right rounded-2xl border border-gray-200 bg-white shadow-xl p-2">
          <div className="py-2 text-sm text-black flex flex-col gap-2">
            <div className="flex flex-wrap gap-2">
              {filterList &&
                filterList.map(({ field, value }) => {
                  const fieldLabel =
                    filters.find((f) => f.value === field)?.label || field;
                  return (
                    <div className="flex items-center gap-1 bg-primary/5 border border-neutral-200 rounded-full px-3 py-1 transition-all">
                      ...
                      <button
                        className="ml-1 text-primary/50 hover:text-primary p-0.5 rounded-full hover:bg-primary/10 transition-colors"
              ...
              if (value === "batch") {
                return (
                  <div
                    ...
                    className="flex flex-col bg-white border border-neutral-100 rounded-2xl shadow p-4 transition-all"
                  >
                    <button
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        {!batchOpen && (
                          <span className="text-sm text-neutral-c justify-self-end">
                            Year
                          </span>
                        )}
                        <ChevronDown
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <h1
                        className={`font-medium ${gradOpen ? "text-base" : ""}`}
                      >
                        {label}
                      </h1>
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <h1
                        className={`font-medium ${jobOpen ? "text-base" : ""}`}
                      >
                        {label}
                      </h1>
                ...
                return (
                  ...
                  >
                    <button
                      onClick={() => setStandingOpen(!standingOpen)}
            ...
            <div>
              <button
                className="text-primary pl-2 py-1 hover:text-hover"
