...
function JobTable({ data, jobType, loading = false }) {
  ...
  const emptyRows = loading ? 0 : Math.max(0, 10 - data.length);
      ...
      <table className="w-full table-fixed">
        <thead>
          <tr className="text-left text-sm text-primary font-satoshi-bold border-b border-gray-200">
            <th className="py-2 px-4" style={{ width: columnWidths.col1 }}>
              Date Posted
            </th>
          ...
          {loading ? (
            ...
            rowsToRender.map((_, index) => (
              <tr key={`skeleton-${index}`} className="border-b border-gray-200 h-10">
                ...
                <td className="py-3 px-4" style={{ width: columnWidths.col2 }}>
                  <div className="h-6 bg-gray-200 rounded animate-pulse w-5/6"></div>
                </td>
                <td className="py-3 px-4" style={{ width: columnWidths.col3 }}>
                  <div className="h-6 bg-gray-200 rounded animate-pulse w-2/3"></div>
                </td>
                <td className="py-3 px-4" style={{ width: columnWidths.col4 }}>
                  <div className="h-6 bg-gray-200 rounded animate-pulse w-1/2"></div>
                </td>
                <td className="py-3 px-4" style={{ width: columnWidths.col5 }}>
            ...
            <>
              ...
              {rowsToRender.map((job, index) => (
                <tr key={index} className="border-b border-gray-200 h-10">
                  <td className="py-3 px-4 font-satoshi-regular" style={{ width: columnWidths.col1 }}>
            ...
            <div className="flex flex-row gap-6 p-6 h-4/5 w-full">
              ...
              <div className="flex flex-col md:w-3/5 bg-white rounded-2xl shadow p-6">
                ...
                <div className="pt-4 flex w-full justify-end">
                  <button
                    className="bg-error hover:bg-red-800 text-white px-6 py-2 rounded-3xl font-satoshi-medium text-lg cursor-pointer"
              ...
              <div className="md:w-2/5 bg-white rounded-2xl shadow overflow-hidden">
                ...
                <div className="p-6">
                  ...
                  <p className="text-2xl font-satoshi-regular">{selectedJob.company}</p>
                  ...
                  <p className="font-satoshi-regular">
                    ...
                    {new Date(selectedJob.date_posted).toLocaleTimeString('en-US', {
                      hour: 'numeric',
                      minute: '2-digit',
                      hour12: true,
                    })}
                  ...
                  <p className="font-satoshi-regular text-md">
                    <span className="font-satoshi-medium">Employment type:</span> {selectedJob.employment_type}
                  </p>
                  <p className="font-satoshi-regular text-md">
                    <span className="font-satoshi-medium">Mode:</span> {selectedJob.mode}
                  </p>

                  <h3 className="font-satoshi-medium text-lg">Description</h3>
                  <p className="font-satoshi-regular text-md">{selectedJob.description}</p>
                </div>
              </div>
            </div>
          ) : (
          ...
          <div className="flex flex-col justify-center items-center bg-white p-6 rounded-3xl shadow-lg w-[400px] min-h-[250px]">
            {removeLoading ? (
              ...
              <>
                ...
                <p className="text-xl font-satoshi-medium mt-4 text-center">Post successfully removed!</p>
                <button
              ...
              <>
                ...
                <div className="pt-8 font-satoshi-medium flex gap-3 mt-6 w-full h-full justify-center">
                  <button
