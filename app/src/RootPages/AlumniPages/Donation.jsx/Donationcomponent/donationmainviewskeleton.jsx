...
function DonationMainViewSkeleton() {
  return (
    <div className="overflow-hidden max-h-[650px]">
      ...
      {/* Image Skeleton */}
      <div className="w-[90%] h-[250px] max-h-[250px] mx-auto rounded-4xl bg-gray-300 animate-pulse"></div>

      {/* Title Skeleton */}
      <div className="lg:w-[95%] w-[90%] pt-4">
        <div className="h-6 bg-gray-300 animate-pulse w-[60%] rounded-lg my-2"></div>
      </div>
      ...
      <div className="flex flex-wrap lg:w-[95%] w-[90%] pt-2 text-black font-satoshi-regular">
        <div className="h-4 bg-gray-300 animate-pulse w-[80%] rounded-lg mb-2 mt-2"></div>
