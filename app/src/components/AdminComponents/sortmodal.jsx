  ...
  return (
    <div className="relative inline-block text-left">
      <button
        ...
        className="border border-disabled rounded-3xl px-5 py-2 cursor-pointer flex items-center gap-1 font-satoshi-light text-black hover:border-hover hover:shadow-md bg-white duration-150 ease-in"
