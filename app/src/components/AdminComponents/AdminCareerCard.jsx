...
function AdminCareerCard({ job, onPrev, onNext, loading }) {
  return (
    <div className='relative border border-gray-300 rounded-2xl shadow-lg min-h-44 py-6 px-16 w-full bg-white items-center flex flex-row justify-between'>
      {loading ? (
        <div className='flex flex-row justify-between items-center w-full'>
          {/* Skeleton for Role, Location */}
          <div className='flex flex-col gap-2'>
            <div className='w-[200px] h-6 bg-gray-200 rounded animate-pulse' />
            <div className='w-[150px] h-4 bg-gray-200 rounded animate-pulse' />
            <div className='w-[150px] h-4 bg-gray-200 rounded animate-pulse' />
          </div>
          {/* Skeleton for Interested, Date, Person */}
          <div className='flex flex-col gap-2'>
        ...
        <>
          ...
          <div className='flex flex-row justify-between items-center w-full cursor-pointer' onClick={() => {}}>
            ...
            <div className='flex flex-col'>
              ...
              <p className='font-satoshi-regular'>{job.a}</p>
            </div>
            ...
            <div className='flex flex-col'>
              ...
              <div className='flex flex-row gap-2'>
                ...
                <p className='font-satoshi-regular'>
                  ...
                  {new Date(job.date_posted).toLocaleTimeString('en-US', {
                    hour: 'numeric',
                    minute: '2-digit',
                    hour12: true
                  })}
