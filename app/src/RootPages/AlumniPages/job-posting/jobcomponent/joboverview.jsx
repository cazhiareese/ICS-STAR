...
function JobOverviewCard({ overview }) {
  return (
    <div className="relative border border-gray-300 rounded-[20px] shadow-xl max-h-[178px]  py-6 px-8 sm:px-12 w-full max-w-[1100px] mx-auto  bg-whitey flex flex-row justify-between items-center mb-6">
