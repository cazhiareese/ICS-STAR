...
function DonationInstructions(
    ...
    // For monetary donatiion instruction
    ...
    // For in-kind donation instruction
    if (donationType == 'inKind') {
        return (
            <div className='outline-2 rounded-3xl outline-neutral-400 py-10 px-10 w-full'>
                ...
                {/* Ordered Steps */}
                <ol>
                    <li className='font-satoshi-regular text-md'>1. Contact ICS</li>
                    {/* QR code
                    <img src="sample" alt="Placeholder" className="w-40 h-40 rounded-3xl outline my-5 ml-20" /> */}
                    <li className='font-satoshi-regular text-md'>2. Schedule.</li>
                    <li className='font-satoshi-regular text-md'>3. Give.</li>
                </ol>
